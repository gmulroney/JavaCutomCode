...
<a href="http://search.maven.org/remotecontent?filepath=com/stackmob/customcode/0.6.1/customcode-0.6.1.jar">Download the latest JAR</a>.
...
```scala
libraryDependencies += "com.stackmob" % "customcode" % "0.6.1" % "provided"
```
...
<p><a href="https://github.com/stackmob/stackmob-customcode-java-examples" target="_blank" class="button">Fork the Custom Code Example on GitHub</a></p>
...
* <a href="http://stackmob.github.com/stackmob-customcode-sdk/0.6.1/apidocs/com/stackmob/sdkapi/http/HttpService.html" target="_blank">See JavaDoc documentation for HttpService</a>
...
[See the CachingService JavaDoc](http://stackmob.github.com/stackmob-customcode-sdk/0.6.1/apidocs/com/stackmob/sdkapi/caching/CachingService.html)
...
<span class="tab caching"/>

# Release Notes

<a href="https://github.com/stackmob/stackmob-customcode-sdk/blob/master/CHANGELOG.md">Release notes are available here</a>.

# Javadocs

<a href="http://stackmob.github.com/stackmob-customcode-sdk/0.6.1/apidocs/">Javadocs are available here</a>.
...
>>>>>>> c58e83a9ae0b14eabd4dab3321ec542895231af1
