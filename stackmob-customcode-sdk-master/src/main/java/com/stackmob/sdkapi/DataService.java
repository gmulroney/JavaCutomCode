...
public interface DataService {
   ...
   * where each sub-object is a List, Map, String, Long, Double or Binary depending on the type of the field in question.
   *
   ...
   *
   * @param schema the name of the object model to count
   * @return the number of objects in the datastore for the given object model that match conditions
   * @throws InvalidSchemaException if the object model specified does not exist
   * @throws DatastoreException if the connection to the datastore fails or the datastore encounters an error
   */
  long countObjects(String schema, List<SMCondition> conditions) throws InvalidSchemaException, DatastoreException;
